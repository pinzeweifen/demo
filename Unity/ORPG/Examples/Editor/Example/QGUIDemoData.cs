...
public partial class QGUIDemo : EditorWindow
{
    ...
    private static QDbDataType[] m_ColType;
...
public partial class QGUIDemo
{
    ...
    private static void CreateConsumption()
    {
        ...
        m_ColType = new QDbDataType[] { QDbDataType.INTEGER, QDbDataType.TEXT, QDbDataType.TEXT, QDbDataType.INTEGER };
