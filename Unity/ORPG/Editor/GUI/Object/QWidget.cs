...
{
    public partial class QWidget:QObject, IQObject
    {
    ...
    {
        public QWidget(EditorWindow window, IQObject parent = null) : base(window, parent)
        {
        }

        public QWidget(EditorWindow window, string name, IQObject parent = null) : base(window, parent)
        {
            m_Name = name;
        }
