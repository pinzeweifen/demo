...
{
    public abstract class QAbstractItemView : QWidget, IQWidget
    {
        ...
        protected List<IQViewItem> m_List = new List<IQViewItem>();

        public int Index { get { return m_Index; } }
        public int Count { get { return m_List.Count; } }
        public float Space { get { return m_Space; } set { m_Space = value; } }

        public IQViewItem this[int index] {
            get {
        ...
        public QAbstractItemView(EditorWindow window, IQObject parent = null) : base(window, parent)
        {
        ...
        public void Add(IQViewItem item)
        {
            m_List.Add(item);
        ...
        public void Remove(IQViewItem item)
        {
        ...
        public IQViewItem RemoveAt(int index)
        {
