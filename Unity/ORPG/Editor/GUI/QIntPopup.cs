...
{
    public class QIntPopup : QWidget, IQWidget
    {
        ...
        public QIntPopup(EditorWindow window, IQObject parent = null) : base(window, parent)
        {
        }

        public QIntPopup(EditorWindow window, string name, IQObject parent = null) : base(window, name, parent)
        {
        }
    ...
    {
        public static QIntPopup ToIntPopup(this IQWidget widget)
        {
