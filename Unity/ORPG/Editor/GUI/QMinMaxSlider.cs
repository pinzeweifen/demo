...
{
    public class QMinMaxSlider : QWidget, IQWidget
    {
        ...
        public QMinMaxSlider(EditorWindow window, IQObject parent = null) : base(window, parent)
        {
        }

        public QMinMaxSlider(EditorWindow window, string name, IQObject parent = null) : base(window, name, parent)
        {
        }
    ...
    {
        public static QMinMaxSlider ToMinMaxSlider(this IQWidget widget)
        {
