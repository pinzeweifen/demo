...
{
    public class QVector3Field : QWidget, IQWidget
    {
        protected Vector3 m_Value;

        public Vector3 Value { get { return m_Value; } set { m_Value = value; } }

        public QVector3Field(EditorWindow window, IQObject parent = null) : base(window, parent)
        {
        }

        public QVector3Field(EditorWindow window, string name, IQObject parent = null) : base(window, name, parent)
        {
        }
    ...
    {
        public static QVector3Field ToVector3Field(this IQWidget widget)
        {
