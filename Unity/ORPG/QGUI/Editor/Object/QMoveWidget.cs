...
namespace QGUI
{
    public class QMoveWidget : QWidget, IWidget
    {
        protected bool isDrag = false;
        protected Vector2 m_Pos;
        protected IWidget m_Target;
        ...
        public QMoveWidget(EditorWindow window, IWidget target, IObject parent = null) : base(window, parent)
        {
            m_Target = target;
        }
