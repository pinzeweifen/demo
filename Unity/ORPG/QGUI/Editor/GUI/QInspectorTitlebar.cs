...
namespace QGUI
{
    public class QInspectorTitlebar : QWidget, IWidget
    {
        ...
        public QInspectorTitlebar(EditorWindow window, IObject parent = null) : base(window, parent)
        {
        }

        public QInspectorTitlebar(EditorWindow window, string name, IObject parent = null) : base(window, name, parent)
        {
        }
    ...
    {
        public static QInspectorTitlebar ToInspectorTitlebar(this IWidget widget)
        {
