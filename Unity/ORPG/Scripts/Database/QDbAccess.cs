...
namespace QRPG.Database
{
    public enum QDbDataType
    {
        /// <summary>
        /// 一个 NULL 值
        /// </summary>
    ...
    public class QDbAccess
    {
        ...
        public QDbAccess() { }
        public QDbAccess(string connectionString)
        {
        ...
        public void OpenDB(string connectionString)
        {
            try
            {
                dbConnection = new SqliteConnection(@"data source="+ connectionString+".db");
                dbConnection.Open();
        ...
        /// <returns></returns>
        public SqliteDataReader CreateTable(string name, string[] colName, QDbDataType[] colType, int keyIndex = -1, int[] notNull = null)
        {
        ...
        public SqliteDataReader InsertIntoSpecific(string tableName, string[] cols, string[] values)
        {
            ...
            return ExecuteQuery(string.Format("INSERT INTO {0} ({1}) VALUES({2})", 
                tableName, ArrayToString(cols), ArrayToString(values, true)));
